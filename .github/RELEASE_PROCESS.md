...
This repo uses [GitHub releases](https://github.com/danghoangnhan/open-geofm/releases) +
...
2. Go to **Settings → GitHub** and flip the **danghoangnhan/open-geofm** toggle ON.
