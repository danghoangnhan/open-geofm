...
Pedagogical documentation for [`open-geofm`](https://github.com/danghoangnhan/open-geofm),
an educational, single-RTX-5090 reproduction of *GeoFM* (Zhang et al., 2025, arXiv:2510.27448).

> **This is not the official GeoFM code.** See the [README](https://github.com/danghoangnhan/open-geofm#readme) for the IS / IS NOT table.
