...
```bash
git clone https://github.com/danghoangnhan/geofm
cd open-geofm
uv sync --extra dev
...
1. **Open an issue** before large changes — describe what you'd improve and which
   pedagogical phase it belongs to (see [wiki/00-Overview](https://github.com/danghoangnhan/geofm/wiki/00-Overview)).
